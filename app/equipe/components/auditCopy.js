...
export const ACTION_COPY = {
  ...
  team_user_bootstrapped: { label: "Usuário da equipe criado (bootstrap)", tone: "" },
  team_user_created: { label: "Usuário da equipe criado", tone: "" },
  team_user_status_updated: { label: "Status de usuário atualizado", tone: "" },
  ...
  paid_after_expiry_conflict: { label: "Pix pago após expiração", tone: "danger" },
  ...
  payment_reconciliation_exception: { label: "Exceção de conciliação Pix", tone: "warn" },
  ...
  patient_access_recovery_requested: {
    label: "Recuperação de acesso solicitada",
    tone: "warn",
  },
  ...
  cultivation_batch_advanced: { label: "Lote avançou semana", tone: "" },
